...
from app.modules.users.schema import UserPrivateResponse, UserUpdate
...
# Mantido por compatibilidade com clientes existentes; aplica a mesma atualizacao parcial do PATCH.
